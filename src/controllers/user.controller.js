...
const changeCurrentPassword = asyncHandler(async(req,res)=>{
    ...
    return res
    .status(200)
    .json(ApiResponse(200,{},"The Password Is Changed Successfully"))
})

const getCurrentUser =asyncHandler(async(req,res)=>{
    return res
    .status(200)
    .json(200,req.user,"The user is fetched successfully")
...
const updateUserAvatar = asyncHandler(async(req,res)=>{
    ...
    if(!avatarLocalPath){
        throw new ApiError(401,"Please enter the file");
    }
...
const updateUserCoverImage = asyncHandler(async(req,res)=>{
    ...
    if(!coverImageLocalPath){
        throw new ApiError(401,"Please enter the avatar file");
    }
